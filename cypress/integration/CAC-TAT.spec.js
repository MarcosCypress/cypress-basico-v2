...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefon',function(){
        ...
        cy.get('#email').type('Marcos@exemplo,com.br').should('have.value','Marcos@exemplo,com.br').clear().should('have.value', '')
        cy.get('#phone').type('21987654321').should('have.value','21987654321').clear().should('have.value', '')
    })
